...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('viewer', 'member');
  CREATE TYPE "public"."enum_admins_role" AS ENUM('super-admin', 'content-manager');
  CREATE TYPE "public"."enum_pages_template" AS ENUM('homepage', 'page-with-hero', 'page-without-hero');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_template" AS ENUM('homepage', 'page-with-hero', 'page-without-hero');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_category" AS ENUM('blog', 'news', 'press-release', 'tutorial');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_category" AS ENUM('blog', 'news', 'press-release', 'tutorial');
  ...
  CREATE TABLE IF NOT EXISTS "admins" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  	"role" "enum_admins_role" DEFAULT 'content-manager',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"email" varchar NOT NULL,
  	"reset_password_token" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_related_pages" (
  ...
  CREATE TABLE IF NOT EXISTS "pages" (
  	...
  	"content" jsonb,
  	"slug" varchar,
  	"template" "enum_pages_template" DEFAULT 'page-with-hero',
  	"meta_title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_version_related_pages" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"category" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v" (
  	...
  	"version_template" "enum__pages_v_version_template" DEFAULT 'page-with-hero',
  ...
  CREATE TABLE IF NOT EXISTS "_posts_v" (
  	...
  	"version_category" "enum__posts_v_version_category" DEFAULT 'blog',
  	"version_content" jsonb,
  	"version_slug" varchar,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_related_pages" ADD CONSTRAINT "pages_related_pages_thumbnail_id_media_id_fk" FOREIGN KEY ("thumbnail_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_related_pages" ADD CONSTRAINT "pages_related_pages_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_version_related_pages" ADD CONSTRAINT "_pages_v_version_related_pages_thumbnail_id_media_id_fk" FOREIGN KEY ("thumbnail_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_version_related_pages" ADD CONSTRAINT "_pages_v_version_related_pages_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "posts_related_posts" ADD CONSTRAINT "posts_related_posts_thumbnail_id_media_id_fk" FOREIGN KEY ("thumbnail_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_posts_v_version_related_posts" ADD CONSTRAINT "_posts_v_version_related_posts_thumbnail_id_media_id_fk" FOREIGN KEY ("thumbnail_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_related_pages_order_idx" ON "pages_related_pages" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_related_pages_parent_id_idx" ON "pages_related_pages" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_related_pages_thumbnail_idx" ON "pages_related_pages" USING btree ("thumbnail_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_version_related_pages_order_idx" ON "_pages_v_version_related_pages" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_version_related_pages_parent_id_idx" ON "_pages_v_version_related_pages" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_version_related_pages_thumbnail_idx" ON "_pages_v_version_related_pages" USING btree ("thumbnail_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_version_version_template_idx" ON "_pages_v" USING btree ("version_template");
  ...
  CREATE INDEX IF NOT EXISTS "posts_related_posts_thumbnail_idx" ON "posts_related_posts" USING btree ("thumbnail_id");
  ...
  CREATE INDEX IF NOT EXISTS "posts_rels_admins_id_idx" ON "posts_rels" USING btree ("admins_id");
  ...
  CREATE INDEX IF NOT EXISTS "_posts_v_version_related_posts_thumbnail_idx" ON "_posts_v_version_related_posts" USING btree ("thumbnail_id");
  ...
  CREATE INDEX IF NOT EXISTS "_posts_v_rels_admins_id_idx" ON "_posts_v_rels" USING btree ("admins_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_related_pages" CASCADE;
  DROP TABLE "pages" CASCADE;
  DROP TABLE "_pages_v_version_related_pages" CASCADE;
  DROP TABLE "_pages_v" CASCADE;
  DROP TABLE "posts_related_posts" CASCADE;
  DROP TABLE "posts" CASCADE;
  DROP TABLE "posts_rels" CASCADE;
  DROP TABLE "_posts_v_version_related_posts" CASCADE;
